...
<?php echo link_to(__("Continue",array(),'sfForkedApply'), $sf_user->isAuthenticated() ? sfConfig::get('app_sfForkedPlugin_afterLogin', sfConfig::get('app_sfForkedPlugin_after', sfConfig::get('app_sfApplyPlugin_afterLogin', sfConfig::get('app_sfApplyPlugin_after', '@homepage')))) : sfConfig::get('app_sfForkedApply_after', sfConfig::get('app_sfApplyPlugin_after', $sf_user->getReferer('@homepage')))) ?>
</p>
